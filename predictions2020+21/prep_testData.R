...
# load 2021 test data
load('../data/processed_datasets/training_dataset/train_2020+21_TEST.RData')
...
save(test_data.baseline, test_data.day1, test_data.day3, test_data.day14, file='data/test_2020+21.RData')
