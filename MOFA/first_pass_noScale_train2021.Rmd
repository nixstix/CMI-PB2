---
title: "MOFA first pass - process 2021 data"
...
```{r}
load('../data/processed_datasets/training_dataset/train_2021_dataset.RData')     
...
we want to remove samples with a majority of NAs in them (per view/assay)
...
# run MOFA
MOFAobject <- run_mofa(MOFAobject, outfile="../data/MOFA_models//MOFA2_noScale_train2021.hdf5", use_basilisk = TRUE)
MOFAobject
